    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="feedback">
                    <div class="row">
                        <div class="col-sm-10">Have you worked with us? Tell us about your positive experience.</div>
                        <div class="col-sm-2"><button type="button" class="btn pull-right" data-toggle="modal" data-target="#feedback">Get in touch</button></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-md-offset-1 twitter">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 col-md-offset-3 col-lg-2 col-lg-offset-4">
                <div class="love">
